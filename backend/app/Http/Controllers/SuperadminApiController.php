...
class SuperadminApiController extends Controller
{
    ...
    /**
     * Update clinic status (approve, suspend, set trial)
     */
    public function updateClinicStatus(Request $request, $id)
    {
        ...
        // If active, make sure its subscription is active
    ...
    public function savePlan(Request $request)
    {
        ...
        // Standardize limits (-1 or null means unlimited)
    ...
    public function deletePlan($id)
    {
        ...
        // Prevent deleting plan if there are active subscriptions
